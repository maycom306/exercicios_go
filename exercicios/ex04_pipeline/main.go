...
func main() {
	...
	fmt.Println("Digite um valor para que seja percorrido ate ele, mostre os numeros primos e o valor ao quadrado")
	_, err := fmt.Scanln(&ate)
	if err != nil || ate <= 0 {
		fmt.Println("Valor digitado não valido")
